<?php /* Smarty version Smarty-3.1.7, created on 2017-04-18 06:26:59
         compiled from "/usr/local/var/www/htdocs/crm/vtigerd/includes/runtime/../../layouts/vlayout/modules/PriceBooks/ProductPriceBookPopupContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:151141125758f5b1b391d120-94473548%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a0bd27c5def6f233522fc7d373f83387bd71e177' => 
    array (
      0 => '/usr/local/var/www/htdocs/crm/vtigerd/includes/runtime/../../layouts/vlayout/modules/PriceBooks/ProductPriceBookPopupContents.tpl',
      1 => 1492156652,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '151141125758f5b1b391d120-94473548',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58f5b1b39b3e6',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58f5b1b39b3e6')) {function content_58f5b1b39b3e6($_smarty_tpl) {?>
...
" id="parentModule"><input type="hidden" value="Product_PriceBooks_Popup_Js" id="popUpClassName"/><?php $_smarty_tpl->tpl_vars['WIDTHTYPE'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('rowheight'), null, 0);?><div class="bottomscroll-div"><table class="table table-bordered listViewEntriesTable"><thead><tr class="listViewHeaders"><th class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
.</div></div><?php }?></div><div class="clearfix form-actions" style="border: 1px solid #DDDDDD;"><a class="cancelLink pull-right"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</a><button class="btn addButton select pull-right"><i class="icon-plus"></i>&nbsp;<strong><?php echo vtranslate('LBL_ADD_TO',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
